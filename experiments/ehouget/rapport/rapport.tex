...
On introduit un systeme d'écriture composé de 2 règles engendrant les termes normalisés. Ce système de réécriture doit apparaître comme un intermédiaire entre le système très souple qui défini les termes, et le système de réécriture linéaire qui définira les schémas composables.
\begin{center}
	\begin{prooftree}
